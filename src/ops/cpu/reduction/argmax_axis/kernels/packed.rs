...
fn argmax_packed_signed<T: PackedBits>(
    attrs: &OpAttrs,
    a: &Tensor<T>,
    out: &mut Tensor<i64>,
    width: u8,
...
fn argmax_packed_unsigned<T: PackedBits>(
    attrs: &OpAttrs,
    a: &Tensor<T>,
    out: &mut Tensor<i64>,
    width: u8,
...
pub fn argmax_axis_i1_packed(attrs: &OpAttrs, a: &Tensor<I1>, out: &mut Tensor<i64>) -> Result<()> {
    argmax_packed_signed(attrs, a, out, 1)
}

pub fn argmax_axis_i2_packed(attrs: &OpAttrs, a: &Tensor<I2>, out: &mut Tensor<i64>) -> Result<()> {
    argmax_packed_signed(attrs, a, out, 2)
}

pub fn argmax_axis_i4_packed(attrs: &OpAttrs, a: &Tensor<I4>, out: &mut Tensor<i64>) -> Result<()> {
    argmax_packed_signed(attrs, a, out, 4)
}

pub fn argmax_axis_u1_packed(attrs: &OpAttrs, a: &Tensor<U1>, out: &mut Tensor<i64>) -> Result<()> {
    argmax_packed_unsigned(attrs, a, out, 1)
}

pub fn argmax_axis_u2_packed(attrs: &OpAttrs, a: &Tensor<U2>, out: &mut Tensor<i64>) -> Result<()> {
    argmax_packed_unsigned(attrs, a, out, 2)
}

pub fn argmax_axis_u4_packed(attrs: &OpAttrs, a: &Tensor<U4>, out: &mut Tensor<i64>) -> Result<()> {
    argmax_packed_unsigned(attrs, a, out, 4)
}
