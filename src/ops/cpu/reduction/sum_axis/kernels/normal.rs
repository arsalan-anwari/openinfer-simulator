...
pub fn sum_axis_f8_normal(attrs: &OpAttrs, a: &Tensor<F8>, out: &mut Tensor<F8>) -> Result<()> {
    let axes = axes_from_attrs(attrs, a.shape().len())?;
    let keepdims = keepdims_from_attrs(attrs);
    let out_shape = output_shape(a.shape(), &axes, keepdims);
    if out.shape() != out_shape.as_slice() {
...
pub fn sum_axis_f32_normal(attrs: &OpAttrs, a: &Tensor<f32>, out: &mut Tensor<f32>) -> Result<()> {
    sum_axis_f32(attrs, a, out)
}

pub fn sum_axis_f64_normal(attrs: &OpAttrs, a: &Tensor<f64>, out: &mut Tensor<f64>) -> Result<()> {
    sum_axis_f64(attrs, a, out)
}

pub fn sum_axis_i8_normal(attrs: &OpAttrs, a: &Tensor<i8>, out: &mut Tensor<i8>) -> Result<()> {
    sum_axis_i64(attrs, a, out, |v| v as i64, |v| v as i8)
}

pub fn sum_axis_i16_normal(
    attrs: &OpAttrs,
    a: &Tensor<i16>,
    out: &mut Tensor<i16>,
) -> Result<()> {
    sum_axis_i64(attrs, a, out, |v| v as i64, |v| v as i16)
}

pub fn sum_axis_i32_normal(
    attrs: &OpAttrs,
    a: &Tensor<i32>,
    out: &mut Tensor<i32>,
) -> Result<()> {
    sum_axis_i64(attrs, a, out, |v| v as i64, |v| v as i32)
}

pub fn sum_axis_i64_normal(
    attrs: &OpAttrs,
    a: &Tensor<i64>,
    out: &mut Tensor<i64>,
) -> Result<()> {
    sum_axis_i64(attrs, a, out, |v| v, |v| v)
}

pub fn sum_axis_u8_normal(attrs: &OpAttrs, a: &Tensor<u8>, out: &mut Tensor<u8>) -> Result<()> {
    sum_axis_u64(attrs, a, out, |v| v as u64, |v| v as u8)
}

pub fn sum_axis_u16_normal(
    attrs: &OpAttrs,
    a: &Tensor<u16>,
    out: &mut Tensor<u16>,
) -> Result<()> {
    sum_axis_u64(attrs, a, out, |v| v as u64, |v| v as u16)
}

pub fn sum_axis_u32_normal(
    attrs: &OpAttrs,
    a: &Tensor<u32>,
    out: &mut Tensor<u32>,
) -> Result<()> {
    sum_axis_u64(attrs, a, out, |v| v as u64, |v| v as u32)
}

pub fn sum_axis_u64_normal(
    attrs: &OpAttrs,
    a: &Tensor<u64>,
    out: &mut Tensor<u64>,
) -> Result<()> {
    sum_axis_u64(attrs, a, out, |v| v, |v| v)
}
