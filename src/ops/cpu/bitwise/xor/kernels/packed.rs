...
pub fn xor_i1_packed(a: &Tensor<I1>, b: &Tensor<I1>, out: &mut Tensor<I1>) -> Result<()> {
    xor_packed_signed(a, b, out, 1)
}

pub fn xor_i2_packed(a: &Tensor<I2>, b: &Tensor<I2>, out: &mut Tensor<I2>) -> Result<()> {
    xor_packed_signed(a, b, out, 2)
}
...
pub fn xor_u1_packed(a: &Tensor<U1>, b: &Tensor<U1>, out: &mut Tensor<U1>) -> Result<()> {
    xor_packed_unsigned(a, b, out, 1)
}

pub fn xor_u2_packed(a: &Tensor<U2>, b: &Tensor<U2>, out: &mut Tensor<U2>) -> Result<()> {
    xor_packed_unsigned(a, b, out, 2)
}
...
pub fn xor_i1_packed_inplace(a: &mut Tensor<I1>, b: &Tensor<I1>) -> Result<()> {
    xor_packed_signed_inplace(a, b, 1)
}

pub fn xor_i2_packed_inplace(a: &mut Tensor<I2>, b: &Tensor<I2>) -> Result<()> {
    xor_packed_signed_inplace(a, b, 2)
}
...
pub fn xor_u1_packed_inplace(a: &mut Tensor<U1>, b: &Tensor<U1>) -> Result<()> {
    xor_packed_unsigned_inplace(a, b, 1)
}

pub fn xor_u2_packed_inplace(a: &mut Tensor<U2>, b: &Tensor<U2>) -> Result<()> {
    xor_packed_unsigned_inplace(a, b, 2)
}
