...
pub fn shl_normal_dispatch(_attrs: &OpAttrs, inputs: &[TensorValue], output: Option<&mut TensorValue>) -> Result<()> {
    let out = expect_output(output)?;
    match (&inputs[0], out) {
        (TensorValue::I8(a0), TensorValue::I8(out)) => super::kernels::normal::shl_i8_normal(_attrs, a0, out),
        (TensorValue::I16(a0), TensorValue::I16(out)) => super::kernels::normal::shl_i16_normal(_attrs, a0, out),
        (TensorValue::I32(a0), TensorValue::I32(out)) => super::kernels::normal::shl_i32_normal(_attrs, a0, out),
        (TensorValue::I64(a0), TensorValue::I64(out)) => super::kernels::normal::shl_i64_normal(_attrs, a0, out),
        (TensorValue::U8(a0), TensorValue::U8(out)) => super::kernels::normal::shl_u8_normal(_attrs, a0, out),
...
pub fn shl_inplace_dispatch(_attrs: &OpAttrs, _inputs: &[TensorValue], output: Option<&mut TensorValue>) -> Result<()> {
    let out = expect_output(output)?;
    match out {
        TensorValue::I8(a) => super::kernels::normal::shl_i8_inplace(_attrs, a),
        TensorValue::I16(a) => super::kernels::normal::shl_i16_inplace(_attrs, a),
        TensorValue::I32(a) => super::kernels::normal::shl_i32_inplace(_attrs, a),
        TensorValue::I64(a) => super::kernels::normal::shl_i64_inplace(_attrs, a),
        TensorValue::U8(a) => super::kernels::normal::shl_u8_inplace(_attrs, a),
