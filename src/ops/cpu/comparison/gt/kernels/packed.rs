...
pub fn gt_i1_packed(a: &Tensor<I1>, b: &Tensor<I1>, out: &mut Tensor<bool>) -> Result<()> {
    gt_packed_signed(a, b, out, 1)
}

pub fn gt_i2_packed(a: &Tensor<I2>, b: &Tensor<I2>, out: &mut Tensor<bool>) -> Result<()> {
    gt_packed_signed(a, b, out, 2)
}
...
pub fn gt_u1_packed(a: &Tensor<U1>, b: &Tensor<U1>, out: &mut Tensor<bool>) -> Result<()> {
    gt_packed_unsigned(a, b, out, 1)
}

pub fn gt_u2_packed(a: &Tensor<U2>, b: &Tensor<U2>, out: &mut Tensor<bool>) -> Result<()> {
    gt_packed_unsigned(a, b, out, 2)
}
